...
export xmlcatalog, libxml2, xmllint
...
const xmlcatalog_splitpath = ["bin", "xmlcatalog.exe"]
...
const libxml2_splitpath = ["bin", "libxml2-2.dll"]
...
const libxml2 = "libxml2-2.dll"


# Relative path to `xmllint`
const xmllint_splitpath = ["bin", "xmllint.exe"]
